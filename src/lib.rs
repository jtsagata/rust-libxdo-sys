...
extern "C" {
    ...
    pub fn xdo_mouse_down(xdo: *const xdo_t, window: Window, button: libc::c_int) -> libc::c_int;
    ...
    pub fn xdo_click_window(xdo: *const xdo_t, window: Window, button: libc::c_int) -> libc::c_int;
    ...
    pub fn xdo_get_focused_window_sane(xdo: *const xdo_t, window_ret: *mut Window) -> libc::c_int;
    ...
    pub fn xdo_select_window_with_click(xdo: *const xdo_t, window_ret: *mut Window) -> libc::c_int;
    pub fn xdo_set_number_of_desktops(xdo: *const xdo_t, ndesktops: libc::c_long) -> libc::c_int;
    ...
    pub fn xdo_get_current_desktop(xdo: *const xdo_t, desktop: *mut libc::c_long) -> libc::c_int;
